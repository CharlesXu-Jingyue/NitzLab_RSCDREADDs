function [A_Runtimes, ...
          ...
          G_AlternationTurn2,...
          G_AlternationTurn3,...
          G_AlternationTurnAny2,...
          G_AlternationTurnAny3,...
          G_PAlt_Turn1,...
          G_PAlt_Turn2Any,...
          G_PAlt_Turn3Any,...
          ...
          G_P2ndAlt_Turn2Any,...
          G_P2ndAlt_Turn3Any,...
          G_P2ndAlt_Turn2Specific,...
          G_P2ndAlt_Turn3Specific,...
          G_2ndAlternationTurn1,...
          G_2ndAlternationTurn2,...
          G_2ndAlternationTurn3,...
          G_2ndAlternationTurnAny2,...
          G_2ndAlternationTurnAny3,...
          H_SameSideReturn,...
          H_OppSideNextRun,...
          H_PShortReturn,...
          H_PLongReturn,...
          ...
          I_PerfBlocks,...
          I_PermCounter]                                                                = MakeBehavioralStats_wrapped2(NumRoutes,indRecStruct)
...
G_2ndAlternationTurn1 = nan(1,length(B_Runs));
G_2ndAlternationTurn2 = nan(1,length(B_Runs));
G_2ndAlternationTurnAny2 = nan(1,length(B_Runs));
G_2ndAlternationTurn3 = nan(1,length(B_Runs));
G_2ndAlternationTurnAny3 = nan(1,length(B_Runs));

%Turn 1
for jRun = 3:size(G_IsRightTurn_IntOnly,2)
   
        thisAlt1 = G_AlternationTurn1(jRun);
        lastAlt1 = G_AlternationTurn1(jRun-1);
        if thisAlt1 == 1
            if lastAlt1 == 1
                G_2ndAlternationTurn1(jRun) =0;
            end
            if lastAlt1 == 0
                G_2ndAlternationTurn1(jRun) =1;
            end
...
%Specific Turn 
for jRun = 3:length(rightsideIndex)
    thisAlt2R = G_AlternationTurn2((rightsideIndex(jRun)));
    lastAlt2R = G_AlternationTurn2((rightsideIndex(jRun-1)));
        if thisAlt2R ==1 
            if lastAlt2R == 1
                G_2ndAlternationTurn2(rightsideIndex(jRun)) =0;
            end
            if lastAlt2R == 0
                G_2ndAlternationTurn2(rightsideIndex(jRun)) =1;
            end
...
for jRun = 3:length(leftsideIndex)
    thisAlt2L = G_AlternationTurn2((leftsideIndex(jRun)));
    lastAlt2L = G_AlternationTurn2((leftsideIndex(jRun-1)));
        if thisAlt2L ==1 
            if lastAlt2L == 1
                G_2ndAlternationTurn2(leftsideIndex(jRun)) =0;
            end
            if lastAlt2L == 0
                G_2ndAlternationTurn2(leftsideIndex(jRun)) =1;
            end
...
for jRun = 3:size(G_IsRightTurn_IntOnly,2)
        ...
        thisAlt2 = G_AlternationTurn2(jRun);
        lastAlt2 = G_AlternationTurn2(jRun-1);
        if thisTurn2 == 1
            if lastAlt2 == 1
                G_2ndAlternationTurnAny2(jRun) =0;
            end
            if lastAlt2 == 0
                G_2ndAlternationTurnAny2(jRun) =1;
            end
...
%Specific Turn 
for jRun = 3:length(quad1Index)
    thisAlt3A = G_AlternationTurn3((quad1Index(jRun)));
    lastAlt3A = G_AlternationTurn3((quad1Index(jRun-1)));
        if thisAlt3A ==1 
            if lastAlt3A == 1
                G_2ndAlternationTurn3(quad1Index(jRun)) =0;
            end
            if lastAlt3A == 0
                G_2ndAlternationTurn3(quad1Index(jRun)) =1;
            end
...
for jRun = 3:length(quad2Index)
    thisAlt3B = G_AlternationTurn3((quad2Index(jRun)));
    lastAlt3B = G_AlternationTurn3((quad2Index(jRun-1)));
        if thisAlt3B ==1 
            if lastAlt3B == 1
                G_2ndAlternationTurn3(quad2Index(jRun)) =0;
            end
            if lastAlt3B == 0
                G_2ndAlternationTurn3(quad2Index(jRun)) =1;
            end
...
for jRun = 3:length(quad3Index)
    thisAlt3C = G_AlternationTurn3((quad3Index(jRun)));
    lastAlt3C = G_AlternationTurn3((quad3Index(jRun-1)));
        if thisAlt3C ==1 
            if lastAlt3C == 1
                G_2ndAlternationTurn3(quad3Index(jRun)) =0;
            end
            if lastAlt3C == 0
                G_2ndAlternationTurn3(quad3Index(jRun)) =1;
            end
...
for jRun = 3:length(quad4Index)
    thisAlt3D = G_AlternationTurn3((quad4Index(jRun)));
    lastAlt3D = G_AlternationTurn3((quad4Index(jRun-1)));
        if thisAlt3D ==1 
            if lastAlt3D == 1
                G_2ndAlternationTurn3(quad4Index(jRun)) =0;
            end
            if lastAlt3D == 0
                G_2ndAlternationTurn3(quad4Index(jRun)) =1;
            end
...
for jRun = 3:size(G_IsRightTurn_IntOnly,2)
        ...
        thisAlt3 = G_AlternationTurn3(jRun);
        lastAlt3 = G_AlternationTurn3(jRun-1);
        if thisAlt3 == 1
            if lastAlt3 == 1
                G_2ndAlternationTurnAny3(jRun) =0;
            end
            if lastAlt3 == 0
                G_2ndAlternationTurnAny3(jRun) =1;
            end
        ...
        if thisAlt3 == 0
          ...
          G_P2ndAlt_Turn1= nansum(G_2ndAlternationTurn1)/(sum(~isnan(G_2ndAlternationTurn1)));
          G_P2ndAlt_Turn2Any= nansum(G_2ndAlternationTurnAny2)/(sum(~isnan(G_2ndAlternationTurnAny2)));
          G_P2ndAlt_Turn3Any= nansum(G_2ndAlternationTurnAny3)/(sum(~isnan(G_2ndAlternationTurnAny3)));
          G_P2ndAlt_Turn2Specific= nansum(G_2ndAlternationTurn2)/(sum(~isnan(G_2ndAlternationTurn2)));
          G_P2ndAlt_Turn3Specific= nansum(G_2ndAlternationTurn3)/(sum(~isnan(G_2ndAlternationTurn3)));
